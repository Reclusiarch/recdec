...
public class VillageBarrelTileEntity extends LockableLootTileEntity
{
	...
	public VillageBarrelTileEntity(TileEntityType<?> typeIn) 
	{
		super(typeIn);
	}
	
	public VillageBarrelTileEntity() 
	{
		this(TileEntityRegister.VILLAGE_BARREL.get());
	}
	...
	{
		//in lang
		return new TranslationTextComponent("Village Barrel");
	}

	@Override
	protected Container createMenu(int id, PlayerInventory player) 
	{
		return new VillageBarrelContainer(id, player, this);
	}
	...
	public static int getPlayersUsing(IBlockReader reader, BlockPos pos)
	{
		...
		if(state.hasTileEntity())
		{
			...
			{
				return ((VillageBarrelTileEntity)tile).numPlayersUsing;
			}
			else
				return 0;
		}
	...
	public static void swapContents(VillageBarrelTileEntity tile, VillageBarrelTileEntity other)
	{
